...
class Menu:
    def __init__(self, tela):
        ...
        self.titulo = font_titulo.render(
            f'CyberPunk: ano 2077', True, ConfigJogo.COR_TITULO)
        self.subtitulo = font_subtitulo.render(
            f'Pressione espaço para iniciar', True, ConfigJogo.COR_SUBTITULO)
